...
const DEFAULT_SUBTITLE_REFERENCE_FONT_SIZE = 54;
const DEFAULT_SUBTITLE_REFERENCE_ASPECT_RATIO = 16 / 9;
const DEFAULT_SUBTITLE_WIDTH_CONSTRAINT_BLEND = 0.25;
const DEFAULT_SUBTITLE_FALLBACK_FONT_SIZE = 28;
const DEFAULT_SUBTITLE_MIN_RECOMMENDED_FONT_SIZE = 14;
const DEFAULT_SUBTITLE_MAX_FONT_SIZE = 148;
