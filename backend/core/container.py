...
class Services:
    ...
    TASK_OPERATION_EXECUTOR = ServiceKey("task_operation_executor")
    TASK_RUNNER_REGISTRY = ServiceKey("task_runner_registry")
    ...
    PIPELINE_STEPS = ServiceKey("pipeline_steps")
