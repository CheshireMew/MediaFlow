...
class Settings:
    def __init__(self):
        ...
        self.RUNTIME_MAX_MANAGED_BYTES = 200 * 1024 * 1024 * 1024
        self.RUNTIME_MIN_FREE_BYTES = 5 * 1024 * 1024 * 1024
    ...
    def _apply_env(self):
        ...
        self.RUNTIME_MAX_MANAGED_BYTES = max(
            1,
            _parse_int(
                env.get(RUNTIME_MAX_MANAGED_BYTES_ENV),
                self.RUNTIME_MAX_MANAGED_BYTES,
            ),
        )
        self.RUNTIME_MIN_FREE_BYTES = max(
            0,
            _parse_int(
                env.get(RUNTIME_MIN_FREE_BYTES_ENV),
                self.RUNTIME_MIN_FREE_BYTES,
            ),
        )
